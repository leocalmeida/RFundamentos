...
# *** ATENÇÃO ***
# As funções da família apply aplicam uma função a cada elemento 
# de um objeto (substitui um loop)
# A função do.call aplica uma função ao objeto inteiro 
# e não a cada elemento individualmente
?do.call
